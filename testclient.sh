...
#curl -k https://localhost:8443/export/192.168.99.100:8443/myproject/developer/asdf > _output
...
#curl -k -X POST --data-urlencode @_import.tgz https://localhost:8443/import/192.168.99.100:8443/myproject/developer/asdf
...
curl -k -X POST --data-urlencode @_import.tgz https://localhost:8443/import/console.appuio.ch:443/zhaw-devtest/zhaw-pgkikopoulos1/6693Tak!27414!3ur
